...
if (trim($_SESSION['admin_role']) !== 'Software') {
    session_unset();
    session_destroy();
...
$complaints = $conn->query("
  ...
  JOIN employees e ON c.employee_user_name = e.user_name 
   WHERE c.type = 'Software' AND c.status IN ('Pending', 'Review Pending')
...
<head>
  ...
  <link rel="stylesheet" href="../../../css/admin/software_dashboard.css" />
 ...
 <header class="main-header">
  ...
  <h3><?php echo htmlspecialchars($admin_name, ENT_QUOTES, 'UTF-8'); ?></h3> 
      ...
      <nav class="sidebar-nav">
        <ul>
          <li><a href="MyProfile_software.php"><i class="fa fa-user"></i> My Profile </a></li>
