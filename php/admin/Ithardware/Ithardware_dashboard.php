...
if (trim($_SESSION['admin_role']) !== 'IT Hardware') {
    session_unset();
    session_destroy();
...
$complaints = $conn->query("
  ...
  JOIN employees e ON c.employee_user_name = e.user_name 
   WHERE c.type = 'Hardware' AND c.status IN ('Pending', 'Review Pending')
...
<head>
  ...
  <link rel="stylesheet" href="../../../css/admin/Ithardware_dashboard.css" />
