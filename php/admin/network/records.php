 <?php
  session_start();
  if (!isset($_SESSION['username']) || $_SESSION['admin_role'] !== 'Network') {
...
<body>
  ...
  <div class="dashboard">
    <main class="main-content">
      <a href="network_dashboard.php" class="back-top-btn">
  <i class="fa fa-arrow-left"></i> Back to Dashboard
      ...
      <section class="complaint-records">
        ...
        <h2>All Networking Complaints</h2>
